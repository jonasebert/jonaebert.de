...
<div class="container pb-20">
    <h1 class="text-5xl font-bold text-je-magical-fata_morgana my-2 py-10 font-poppins">{name} - Kontakt</h1>
    <div class="bg-[url('/contact/teaser.webp')] bg-fixed bg-no-repeat bg-center bg-cover rounded-xl pt-10">
        <div class="flex flex-col gap-3 bg-je-mystical-nachtblau-900 p-5 rounded-lg">
            ...
            <form class="flex flex-col gap-3 font-montserrat" on:submit|preventDefault={submitForm}>
                <div class="relative">
                    <input type="text" name="name" id="name" class="block px-2.5 pb-2.5 pt-4 w-full bg-transparent rounded-lg border-2 border-je-mystical-schwarzgruen-500 appearance-none focus:border-je-mystical-waldtiefe-500 focus:outline-none focus:ring-0 peer" placeholder=" " required disabled={submitting !== 0} />
                ...
                <div class="relative">
                    <input type="text" name="pronouns" id="pronouns" class="block px-2.5 pb-2.5 pt-4 w-full bg-transparent rounded-lg border-2 border-je-mystical-schwarzgruen-500 appearance-none focus:border-je-mystical-waldtiefe-500 focus:outline-none focus:ring-0 peer" placeholder=" " disabled={submitting !== 0} />
                ...
                <div class="relative">
                    <input type="email" name="email" id="email" class="block px-2.5 pb-2.5 pt-4 w-full bg-transparent rounded-lg border-2 border-je-mystical-schwarzgruen-500 appearance-none focus:border-je-mystical-waldtiefe-500 focus:outline-none focus:ring-0 peer" placeholder=" " required disabled={submitting !== 0} />
                ...
                <div class="relative">
                    <textarea name="message" id="message" class="block px-2.5 pb-2.5 pt-4 w-full bg-transparent rounded-lg border-2 border-je-mystical-schwarzgruen-500 appearance-none focus:border-je-mystical-waldtiefe-500 focus:outline-none focus:ring-0 peer placeholder-transparent" placeholder=" " rows="4" maxlength="300" required disabled={submitting !== 0}></textarea>
                    <label for="message" class="absolute duration-300 transform -translate-y-4 scale-75 top-2 origin-[0] bg-je-mystical-nachtblau-900 px-2 peer-focus:px-2 peer-focus:text-je-magical-korallenriff peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-[200%] peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1 cursor-text peer-focus:cursor-default">Deine Nachricht *</label>
                </div>
                <label for="message" class="text-xs">Maximal 300 Zeichen</label>
                <div class="inline-flex items-center">
                    <label class="flex items-center cursor-pointer relative">
                        <input type="checkbox" id="privacy" name="privacy" class="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded-md shadow hover:shadow-md border-2 border-je-mystical-schwarzgruen-500 checked:bg-je-mystical-waldtiefe-500 checked:border-je-mystical-waldtiefe-500" required disabled={submitting !== 0} />
                    ...
                    <label for="privacy" class="ms-3">Ich bin mit der <a href="/legal/privacy" target="_blank" class="">Datenschutzerklärung</a> einverstanden.</label>
                </div>
                {#if submitting == 0}
                    <button class="bg-je-mystical-schwarzgruen-500 hover:bg-je-mystical-schwarzgruen-700 text-white p-2 mt-3 hover:text-je-magical-fata_morgana rounded-lg" type="submit">Senden</button>
                {:else if submitting == 1}
                    <button disabled type="submit" class="bg-je-mystical-schwarzgruen-900 text-je-magical-sonnenglanz hover:bg-je-mystical-schwarzgruen-700 focus:ring-4 focus:outline-none focus:ring-je-magical-sonnenglanz rounded-lg p-2 mt-3 text-center inline-flex justify-center items-center cursor-not-allowed">
